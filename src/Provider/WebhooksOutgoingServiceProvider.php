...
class WebhooksOutgoingServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('Ignited\Webhooks\Outgoing\Services\RequestServiceInterface', function ($app) {
            return new RequestService($app['Ignited\Webhooks\Outgoing\Requests\RequestRepositoryInterface'], new Client(), $app['Illuminate\Contracts\Bus\Dispatcher'], $app['events'], $app['config']['webhooks-outgoing']);
        });
